...
After the feast, Kesk says to you, "Now go get some rest, {}. Tomorrow we begin planning our ascent in the food chain."
...
speak_to_passel = '''  You talk to the matron of the grove first. 
She says "My dear {} - you fought to protect this grove and your new gifts.
...
path_1 = '''   At nightfall, you gather your things, cross the creek near the Oak Grove, and find the winding path.
...
You're quite lucky. Your father, Kesk, found and convinced us to help restore dignity to the Opossum. Before now, we have not acted in this world since the Dinosaurs roamed these mountains."

Amanita looks directly at you.

"Yet, now that we have, our overlords have seen to it to test your new abilities. You're being hunted. You are to be the subject of tests both directly and indirectly, and your actions will be monitored closely. Do not betray our trust or disappoint our support for your species." 

"I'll do my best!" you exclaim with hesitation.

"The world is better with you in it, {}. Continue to fight for your passel, and for your father. 
...
fox_1 = '''    You keep walking up the winding path. You hear leaves crunching behind you, you look back and you see the fox from before.
...
fox_2 = '''    "I don't need any help from a 'possum. You ARE food... but then again I am confused by what you now have become..."
...
help_fox = ''' "Look, we have food that we have gathered in the Oak Grove just down the path and across the creek. Tell them {} invited you to our grove and they will help."
...
path_3 = '''   You continue your journey up the winding path. The path is well lit from a full moon and an unburdened sky. There are moths dancing in the moonlight, spiders sitting in webs awaiting their meal, and tracks on the path that look like a snake has recently traveled this way. You start to feel the gravity of the situation as you hike the path. Your place in nature as an opossum is confusing but unique. Why and how have I gotten into this?

As you go deeper in your thoughts, and higher up the mountain, you see another fork in the path. You know this is the off-shoot to the maple cave. You see the large maple tree in the distance that stands next to the cave entrance. The maple cave is large enough for a black bear's den. In the past, opossums that you know have not typically wandered this way alone.

Do you continue to the mountain top BALD or go to the maple CAVE?\n'''

maple_cave = '''   As you veer off the winding path into the light brush of the forest toward the Maple Cave, the moonlight gets dimmer.
...
enter_maple_ring = ''' Moments after you step inside the boundary of the ring, you enter a state of trance. Your mind goes blank and you see nothing but darkness. In that darkness, a light appears in the distance. It slowly grows in size as it gets closer to you. In that light you begin to see shapes take form and you make out a vision. You see the Oak Grove but it's empty. You see no other opossums there, not even Kesk. 
...
stomp_maple = '''  You stomp on the mushrooms. As you feel the red yellow-spotted fruiting bodies squish below your paws, your bones shake from a rumble in the dirt, and a growl from above...
...
leave_cave = '''   You run out of the cave. As the moon illuminates your fur, you feel a tingling in the back of your neck. You turn around and look above the cave to see a giant Venus Flytrap that has sprouted tendrils and is reaching for you.

Would you like to RUN or FIGHT?\n'''

after_venus_combat = '''   The Venus Flytrap screeches. Bugs and carrion spew from its mouths. You step aside as it withers and dies. Well fought, {}!

Enter OK to continue.
_____________________\n'''

past_maple_cave = '''  You resume your journey up the winding path. With a few hours left until dawn, you finally reach the top of the mountain. 
...
investigate_snake = '''    You get on all fours and sniff at the snakeskin. It smells different than the snakes that attacked the grove. 

Your eyes squint and you see a snake in the brush nearby roll over, it's white belly reflecting the moonlight. The snake looks to be playing dead.
...
You think to yourself... maybe this is the kind of ally the grove lorekeeper was talking about.
...
no_ally_hognose = ''' "I cannot ally with you. Thank you for telling me about Snakey in the briar thicket, now get out of here before I get hungry."

Enter OK to continue.
_____________________\n'''

briar_dialogue = '''   As you get closer to the center of the mountaintop, you hear hissing, followed by the shaking of rattles coming from inside the briar thicket.
...
Snakey slithers out from under the briars. "You aren't the only one that has found friends {}. I've been given a special purpose to put you and the other 'possums back where you belong. You should NEVER have been given the gifts you took. You are a disgrace to natural order and I will clean up this mess. Prepare to play dead for another millenia. Opossums are cowards!"

You stand up straight. "We don't play dead anymore, Snakey."
